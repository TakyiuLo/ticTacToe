...
var authApp = __webpack_require__(6);
var store = __webpack_require__(1);
var gameApp = __webpack_require__(12);
...
var addSplashScreen = function addSplashScreen() {
  // first page animation
  $('#title h1 span').off('click').on('click', function () {
...
var boxClick = function boxClick(event) {
  ...
  var index = parseInt(event.target.id.substring(4), 10);
...
var startGameProcedures = function startGameProcedures() {
  addHandlers();
  // Mapping Game Count
...
var quitGameProcedures = function quitGameProcedures() {
...
module.exports = {
  startGameProcedures: startGameProcedures,
  quitGameProcedures: quitGameProcedures
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var onUpdateGameOver = function onUpdateGameOver(data) {
  api.updateGame(data).then(ui.onOverSuccess).catch(ui.onOverFailure);
};
...
module.exports = {
  ...
  onGetGame: onGetGame,
  onUpdateGameOver: onUpdateGameOver,
...
var onGetGameSuccess = function onGetGameSuccess(response) {
...
var onOverSuccess = function onOverSuccess() {
  $('.message').text(function () {
...
var onOverFailure = function onOverFailure() {
...
module.exports = {
  ...
  onOverSuccess: onOverSuccess,
  onOverFailure: onOverFailure,
...
var gameObject = {
  ...
  equalVals: function equalVals(element, index, array) {
  ...
  checkWinner: function checkWinner() {
    // diagonals check
    var blackslash = [this.board[0], this.board[4], this.board[8]];
    var slash = [this.board[2], this.board[4], this.board[6]];
    // rows check
    var row1 = [this.board[0], this.board[1], this.board[2]];
    var row2 = [this.board[3], this.board[4], this.board[5]];
    var row3 = [this.board[6], this.board[7], this.board[8]];
    // columns check
    ...
    // check draw
    if (this.board.every(function (element) {
      return element !== '';
    }) && this.winner !== 'X') {
      this.winner = 'draw';
    }
  ...
  chooseCell: function chooseCell(index) {
    // update the local gameBoard
    this.board[index] = this.whosTurn;
    // check is there a winner
    // this.checkWinner()
  },
  updateGamelogic: function updateGamelogic(serverGame) {
...
module.exports = __webpack_require__.p + "926a41028bb2c02b8c527fc3153a4289.ttf";
